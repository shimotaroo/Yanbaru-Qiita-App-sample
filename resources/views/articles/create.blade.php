        ...
        <div class="col-md-8">
            <div class="card mb-5">
                <div class="card-header">
                    <h2 class="text-center mb-0"><i class="fas fa-pen mr-2"></i>記事投稿</h2>
                </div>
                <form action="{{ route('articles.store') }}" method="POST">
                    ...
                    <div class="card-body col-md-8 mx-auto">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="記事タイトル" autofocus required>
                        </div>
                        <div class="form-group mb-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control" id="summary" name="summary" placeholder="記事概要" rows="6" required></textarea>
                            <small id="url" class="form-text text-muted">30文字以上で入力してください。</small>
                        </div>
                        <div class="form-group mb-4">
                            <label for="url">記事URL</label>
                            <input type="url" class="form-control" id="url" name="url" placeholder="記事URL" required>
